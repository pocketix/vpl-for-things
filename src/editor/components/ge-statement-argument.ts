...
export class GeStatementArgument extends LitElement {
  ...
  handleValueChange(e: Event) {
    if (this.argument.type === Types.number || this.argument.type === 'numeric_options') {
  ...
  connectedCallback() {
    ...
    if ((this.argument.type === 'numeric_options' || this.argument.type === 'string_options') && this.argument.value === null) {
      this.argument.value = (
        this.language.statements[this.stmtId] as UnitLanguageStatementWithArgs | CompoundLanguageStatementWithArgs
